...
- Use process.env.EXPO_PUBLIC_POSTHOG_PROJECT_TOKEN and process.env.EXPO_PUBLIC_POSTHOG_HOST to load PostHog configuration from Expo environment variables.
